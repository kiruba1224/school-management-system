...
//	ResponseEntity<ResponseStructure<SchoolResponse>> deleteSchool(Integer schoolId);
	...
	ResponseEntity<ResponseStructure<SchoolResponse>> addstudent(Integer schoolId, SchoolRequest schoolRequest);

	ResponseEntity<ResponseStructure<SchoolResponse>> addteacher(Integer schoolId, SchoolRequest schoolRequest);
