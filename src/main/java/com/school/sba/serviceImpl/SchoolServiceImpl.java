...
public class SchoolServiceImpl implements SchoolService{
	...
	@Override
	public ResponseEntity<ResponseStructure<SchoolResponse>> addstudent(Integer schoolId, SchoolRequest schoolRequest) {
	...
	@Override
	public ResponseEntity<ResponseStructure<SchoolResponse>> addteacher(Integer schoolId, SchoolRequest schoolRequest) {
