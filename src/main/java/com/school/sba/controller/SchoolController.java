...
public class SchoolController {
	...
	public ResponseEntity<ResponseStructure<SchoolResponse>> addstudent(@PathVariable Integer schoolId, @RequestBody SchoolRequest schoolRequest){
		return schoolService.addstudent(schoolId,schoolRequest);
	}

	@PreAuthorize("hasAuthority('ADMIN')")
	@PostMapping("/users/schools")
	public ResponseEntity<ResponseStructure<SchoolResponse>> addteacher(@PathVariable Integer schoolId, @RequestBody SchoolRequest schoolRequest){
		return schoolService.addteacher(schoolId,schoolRequest);
	}
